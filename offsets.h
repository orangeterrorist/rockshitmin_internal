...
constexpr size_t OFFSET_UNITYENGINE_TRANSFORM_GET_POSITION = _OFFSET(0x1821F45E0); //public UnityEngine::Vector3 get_position(); // RVA:
constexpr size_t OFFSET_UNITYENGINE_TRANSFORM_SET_POSITION = _OFFSET(0x1821F5280); //public void set_position(UnityEngine::Vector3 value); // RVA: 
constexpr size_t OFFSET_UNITYENGINE_TRANSFORM_GET_FORWARD = _OFFSET(0x1821F3D20); //public UnityEngine::Vector3 get_forward(); // RVA: 
constexpr size_t OFFSET_UNITYENGINE_TRANSFORM_GET_ROTATION = _OFFSET(0x1821F4850); // public Quaternion get_rotation(); // RVA: 
constexpr size_t OFFSET_UNITYENGINE_TRANSFORM_SET_LOCALSCALE = _OFFSET(0x1821F50D0); //public void set_localScale(UnityEngine::Vector3 value); // RVA: 
...
constexpr size_t OFFSET_UNITYENGINE_QUATERNION_GET_EULERANGLES = _OFFSET(0x1802ADDC0); //public UnityEngine::Vector3 get_eulerAngles(); // RVA:
constexpr size_t OFFSET_UNITYENGINE_QUATERNION_SET_EULERANGLES = _OFFSET(0x1821F4BC0); //public void set_eulerAngles(UnityEngine::Vector3 value); // RVA: 
...
constexpr size_t OFFSET_PHOTONNETWORK_INSTANTIATE = _OFFSET(0x18115DCF0); //	public static GameObject Instantiate(string prefabName, UnityEngine::Vector3 position, Quaternion rotation, float scale, byte group); // RVA:
...
constexpr size_t OFFSET_RECROOM_CORE_COMBAT_RANGEDWEAPON_FIRE_O = _OFFSET(0x180DA8BA0); //	public virtual void Fire(UnityEngine::Vector3 velocity, optional float chargeAmount); // RVA:
