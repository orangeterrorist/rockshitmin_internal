...
namespace native
{
    ...
    // This code is just setting up pointers 
    ...
    namespace UnityEngine
    {
        ...
        struct Quaternion {
            ...
            typedef UnityEngine::Vector3(*_tget_eulerAngles)(Il2CppObject* __this, const MethodInfo* method_info);
        ...
        {
            typedef Object* (*_tInstantiate)(Object* original, UnityEngine::Vector3 pos, Quaternion rot, Transform* parent, const MethodInfo* mi);
        ...
        {
            typedef UnityEngine::Vector3(*_tget_position)(Transform* __this, const MethodInfo* method_info);
            inline static _tget_position get_position;

            typedef void(*_tset_localScale)(Transform* __this, UnityEngine::Vector3 value, const MethodInfo* method_info);
            inline static _tset_localScale set_localScale;

            typedef void(*_tset_position)(Transform* __this, UnityEngine::Vector3 value, const MethodInfo* method_info);
            inline static _tset_position set_position;

            typedef UnityEngine::Vector3(*_tget_forward)(Transform* __this, const MethodInfo* method_info);
        ...
        namespace AddressableAssets {
            struct AssetReference : Il2CppObject {
                typedef ResourceManagement::AsyncOperations::AsyncOperationHandle_1(*_tInstantiate)(AssetReference* __this, UnityEngine::Vector3 pos, Quaternion rot, Transform* parent, const MethodInfo* mi);
    ...
    struct SessionManager : SingletonMonoBehaviourBase 
    {
        ...
        typedef void(*_tLocalPlayerSpawned)(SessionManager* __this, MethodInfo* method_info);
        inline static _tLocalPlayerSpawned LocalPlayerSpawned;

        typedef void(*_tBootLocalPlayerToDormRoom)(SessionManager* __this, Il2CppString* alertmesage, int LoadSceneSources, bool IsValid, MethodInfo* method_info);
        inline static _tBootLocalPlayerToDormRoom BootLocalPlayerToDormRoom;
        ...
        typedef bool(*_tget_IsDev)(MethodInfo* mi);
        inline static _tget_IsDev get_IsDev;
    ...
    {
        typedef Tool* (*_tPhotonInstantiate)(Il2CppString* prefab, UnityEngine::Vector3 Pos, UnityEngine::Quaternion Rot, float scale, unsigned char group, MethodInfo* method_info);
        inline static _tPhotonInstantiate PhotonInstantiate;
    };
        ...
        namespace Core
        {
            ...
            namespace AI
            {
                ...
                struct Enemy : Photon::MonoBehaviour {
                    ...
                    typedef void(*_tMasterKill)(Enemy* __this, System::Collections::Generic::List* Enemy, MethodInfo* mi);
            ...
            namespace Creation {
                ...
                struct CreationManager : NetworkedSingletonMonoBehaviour {
                    typedef long long(*_tget_ActiveSandboxResourceCost)(CreationManager* __this, MethodInfo* mi);
                    inline static _tget_ActiveSandboxResourceCost get_ActiveSandboxResourceCost;
                };
            }
            ...
            namespace Locomotion 
            {
                struct PlayerMovement : UnityEngine::MonoBehaviour
                {
                    ...
                    typedef bool(*_tget_IsFlyingEnabled)(PlayerMovement* __this, MethodInfo* method_info);
            ...
            namespace Combat
            {
                struct Weapon : Photon::MonoBehaviour
                {
                    ...
                    typedef bool(*_tget_HasEnoughMagazineAmmunition)(Weapon* __this, MethodInfo* method_info);
                    inline static _tget_HasEnoughMagazineAmmunition get_HasEnoughMagazineAmmunition; 

                    typedef int (*_tTotalAmmo)(Weapon* __this, MethodInfo* method_info);
                    inline static _tTotalAmmo get_TotalAmmo;

                    typedef int (*_tget_MagAmmo)(Weapon* __this, MethodInfo* method_info);
                    inline static _tget_MagAmmo get_MagAmmo;
                ...
                struct RangedWeapon : Weapon
                {
                    ...
                    typedef void(*_tFire)(RangedWeapon* __this, UnityEngine::Vector3 velocity, float charge, MethodInfo* method_info);
                    inline static _tFire Fire;

                    typedef bool(*_tget_IsOnCooldown)(RangedWeapon* __this, MethodInfo* method_info);
    ...
    struct GameCombatManager : Il2CppObject
    {
        ...
        typedef void(*_tMasterSetPlayerHealth)(
            GameCombatManager* __this,
            PhotonPlayer* player,
            int newhealth,
            MethodInfo* method_info
            );
        inline static _tMasterSetPlayerHealth MasterSetPlayerHealth;
    ...
    struct GameManager : Il2CppObject
    {
        ...
        typedef void(*_tRpcMasterStartGameEarly)(GameManager* __this, native::PhotonPlayer* Player, MethodInfo* method);
        inline static _tRpcMasterStartGameEarly RpcMasterStartGameEarly;

        typedef void(*_tRpcMasterStopGame)(GameManager* __this, MethodInfo* method);
        inline static _tRpcMasterStopGame RpcMasterStopGame;

    };
    struct TypeIl2CppArray : public Il2CppObject
    {
    ...
    struct PhotonNetwork
    {
        ...
        typedef bool(*_tget_SetMasterClient)(PhotonPlayer*, MethodInfo*);
        inline static _tget_SetMasterClient set_MasterClient;
        ...
        typedef Il2CppArray* (*_tget_playerList)(MethodInfo* method_info);
        inline static _tget_playerList get_playerList;

        typedef void(*_tKillLocalPlayerGameOnViolation)(PhotonPlayer* target, MethodInfo* method_info);
        inline static _tKillLocalPlayerGameOnViolation KillLocalPlayerGameOnViolation;
    ...
    struct Il2CppArray2 : public Il2CppObject
    {
        /* bounds is NULL for szarrays */
        Il2CppArrayBounds* bounds;
        /* total number of elements of the array */
    ...
    struct DodgeballManager
    {
        typedef void(*_tRpcMasterRequestPlayerOut)(DodgeballManager* __this, native::PhotonPlayer* thrower, native::PhotonPlayer* outPlayer, native::UnityEngine::Vector3 outPoint, MethodInfo* method);
        inline static _tRpcMasterRequestPlayerOut RpcMasterRequestPlayerOut;
    ...
    struct Player : Photon::MonoBehaviour
    {
        ...
        char __pad2[0x18];
        static PlayerHand* leftHand; // 0x68
        ...
        //    Il2CppImage* get_StaticPlayer = il2cpp_domain_assembly_open(domain, "Assembly-CSharp")->image;
        //    Il2CppClass* get_StaticPlayerClass = il2cpp_class_from_name(get_StaticPlayer, "", "Player");
        //    //std::cout << "Game Pooped!!!" << std::endl;
        //    return (StaticFields*)(get_StaticPlayerClass->methods);
        //}
        ...
        typedef Player* (*_tget_LocalPlayer)(MethodInfo* method_info);
        inline static _tget_LocalPlayer get_LocalPlayer;

        typedef PlayerHead* (*_tget_Head)(Player*, MethodInfo* method_info);
        inline static _tget_Head get_Head;

        typedef System::Collections::Generic::List* (*_tget_AllToolsAttached)(Player*, MethodInfo* method_info);
        inline static _tget_AllToolsAttached get_AllToolsAttached;

        typedef Il2CppArray* (*_tGetAllPlayers)(bool, MethodInfo* method_info);
        inline static _tGetAllPlayers GetAllPlayers;

        typedef Player* (*_tGetClosestPlayer)(UnityEngine::Vector3, bool, MethodInfo* method_info);
        inline static _tGetClosestPlayer GetClosestPlayer;

        typedef Il2CppArray* (*_tFindObjectsOfType)(Il2CppObject* __this, MethodInfo* method_info);
        inline static _tFindObjectsOfType FindObjectsOfType;

        typedef Player* (*_tGetPlayerByAccountID)(int, bool, MethodInfo* method_info);
        inline static _tGetPlayerByAccountID GetPlayerByAccountID;
    };

    struct RecNetRunTime 
    {
        typedef bool(*_tAlwaysValidVerifyer)(DWORD*, DWORD*, DWORD*, MethodInfo* mi);
        inline static _tAlwaysValidVerifyer AlwaysValidVerifyer_IsValid;

        typedef bool(*_tHPBCIOKGCPD)(DWORD*, DWORD*, DWORD*, MethodInfo* mi);
        inline static _tHPBCIOKGCPD IsValid;

        typedef bool(*_tTimeValidVerifyer)(DWORD*, DWORD*, DWORD*, MethodInfo* mi);
        inline static _tTimeValidVerifyer TimeValidVerifyer_IsValid;

    };

    struct GlobalModel
    {
        typedef bool(*_tget_LocalAccountIsDeveloper)(GlobalModel* __this, MethodInfo* mi);
        inline static _tget_LocalAccountIsDeveloper get_LocalAccountIsDeveloper;
    };
    struct ClothingCustomizerModel 
    {
        typedef bool(*_tget_CanUseBackpackTool)(ClothingCustomizerModel* __this, MethodInfo* mi);
        inline static _tget_CanUseBackpackTool get_CanUseBackpackTool;

    };
    struct EKHDFFJLCMO 
    {

        typedef bool(*_tLocalRemoveTrialItems)(EKHDFFJLCMO* __this, DWORD* item, MethodInfo* mi);
        inline static _tLocalRemoveTrialItems LocalRemoveTrialItems;
    };
    struct EACManager 
    {

        typedef void(*_tUpdate)(EACManager* __this, MethodInfo* method_info);
        inline static _tUpdate Update;

        typedef void(*_tOnApplicationQuit)(EACManager* __this, MethodInfo* method_info);
        inline static _tOnApplicationQuit OnApplicationQuit;

        typedef void(*_tOnApplicationQuit)(EACManager* __this, MethodInfo* method_info);
        inline static _tOnApplicationQuit OnApplicationQuit2;
